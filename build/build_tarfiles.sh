...
#get amd64 binary
wget -O netclient "https://github.com/gravitl/netmaker/releases/download/v$VERSION/netclient_darwin_amd64"
chmod +x netclient
...
#get arm64 binary
wget -O netclient "https://github.com/gravitl/netmaker/releases/download/v$VERSION/netclient_darwin_arm64"
chmod +x netclient
